# -*- coding: utf-8 -*-
"""
从 UTF-8 恢复 config.yml。
因 Cursor 编辑工具可能导致 config.yml 中文乱码，今后修改配置请：
1. 编辑本脚本中的 CONFIG 字符串
2. 运行: python scripts/restore_config.py
"""
import os
...
messages:
  ...
  outputting_confirm: "好的，正在为您生成今天的跟进记录，感谢您的确认！"

  outputting_ended: "对话已结束，如果有新的客户跟进情况要整理，再找我~"
...
if __name__ == '__main__':
    ...
    print('config.yml restored with UTF-8 encoding')
